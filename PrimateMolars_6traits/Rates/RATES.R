#HEADER-----
setwd("~/PrimateMolars_3traits/Rates/")
library(RRphylo)
library(emorph2)
library(data.table)
library(ape)
...
means_red<-select(means,Species,m1a,m2a,m3a) %>% 
  na.omit
...
Nes<-runif(n = 20000, 500000,1000000)
...
tree_LGGD.plot<-
  ggtree(g2, aes(color=rate), size=1,layout="fan")+
  # scale_color_gradientn(colors=c("darkgreen","darkgreen","darkgreen","darkgreen","gray","gray","gray","gray","gray","mediumpurple4","mediumpurple4"),
  scale_color_gradientn(colors=c("darkgreen","darkgreen","darkgreen","darkgreen","darkgreen","darkgreen","darkgreen","gray","gray","gray","mediumpurple4","mediumpurple4","mediumpurple4"),
...
ggsave("rate_age.pdf",rate_age.plot,width = 7,height = 5)
