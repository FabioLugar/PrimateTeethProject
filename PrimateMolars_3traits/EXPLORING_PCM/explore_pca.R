...
#Global model----
load("~/PrimateMolars_3traits/GlobalModels_PCA/fitGlobal.Rdata")
...
log(2)/diag(PCMApplyTransformation(bestModels$OU)$H[,,1])
...
#Mixed model----
load("~/PrimateMolars/MixedModels/fitMIXED.RData")
